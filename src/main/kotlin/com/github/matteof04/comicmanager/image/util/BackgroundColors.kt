...
/**
 * Background colors for fill the gap between the resized images and the screen
 * @param color [Color] The AWT color
 * @property WHITE White AWT color
 * @property BLACK Black AWT color
 * @property AUTO Leave to the processor the job to find the best color
 * @property NONE Don't use background color
 */
