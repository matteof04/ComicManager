...
/**
 * Metadata for panels
 * @property ROTATED The image of the panel is rotated
 * @property FIRST_SPLIT The image of the panel is the first part of a double-page image
 * @property SECOND_SPLIT The image of the panel is the second part of a double-page image
 */
enum class PanelMetadata {
    ROTATED,
    FIRST_SPLIT,
    SECOND_SPLIT
}