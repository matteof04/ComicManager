...
object Palettes {
    val PALETTE_16 = Palette(arrayOf(0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff))
    val PALETTE_15 = Palette(arrayOf(0x00,0x11,0x22,0x33,0x44,0x55,0x66,0x77,0x88,0x99,0xaa,0xbb,0xcc,0xdd,0xff))
    val PALETTE_4 = Palette(arrayOf(0x00,0x55,0xaa,0xff))
}